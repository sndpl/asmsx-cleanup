...
void msx_bios(void);
void register_label(const char *);
void register_local(const char *);
void register_symbol(const char *, int, int);
void register_variable(const char *, int);
